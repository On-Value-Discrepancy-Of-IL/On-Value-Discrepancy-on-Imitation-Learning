...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        self.g_history = deque(maxlen=20)
    ...
    def store_episode(self, episode_batch, update_stats=False):
        """
    ...
    def sample_batch(self):
        ...
        self.reward_history.append(np.mean(transitions['r']))
        self.g_history.append(np.mean(np.linalg.norm(transitions['g'], axis=-1)))
    ...
    def logs(self, prefix=''):
        ...
        logs += [('her_r/mean', np.mean(self.reward_history))]
        logs += [('her_g/mean', np.mean(self.g_history))]
