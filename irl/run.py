...
def configure_log(alg, env):
    ...
    for subdir in ['env', 'rl', 'irl', 'gym_minigrid']:
...
def main(args):
    ...
    env = build_env(args.env_id, num_env=args.num_env, seed=args.seed, irl_wrapper=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--rl_max_steps', type=int, default=2e5)
